    ...
    return (
        <div className='repo-container'>
            ...
            <div className='owner-block'>
                ...
                <span>Owner: <a href={repo.owner.url} target='_blank' rel='noreferrer'>{repo.owner.login}</a></span>
            </div>
            <div className='languages-block'>
                <h2>Languages</h2>
                <ol>{repo.languages.nodes.map((item) => <li key={item.name}>{item.name}</li>)}</ol>
            </div>
